...
// SaveSchema stores a schema definition
...
// LoadSchema loads a schema definition by name
...
// SaveConfigSheet stores a config sheet for a project environment
...
// LoadConfigSheet loads a config sheet for a project environment
